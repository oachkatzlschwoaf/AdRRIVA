...
<div class='content_container mt_10'>
    <div class='l_side text_header ta_r'>
        ...
        <br />
        <?php print link_to('&larr; Назад', 'default/index'); ?>
    </div>
    <div class='r_side text_header'>
        Мы рекомендуем вам ознакомиться со следующей информацией:
        <br />
        <br />
        <?php print link_to('Раздел помощи на нашем сайте', 'default/help'); ?> &mdash; в нем вы найдете ответы на наиболее частые вопросы: как работает система, как создавать рекламу и пр.
        <br />
        <br />
        Остались вопросы?
