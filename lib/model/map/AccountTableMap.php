...
class AccountTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('BALANCE', 'Balance', 'INTEGER', true, 7, null);
    ...
    $this->addRelation('OutgoingFunds', 'OutgoingFunds', RelationMap::ONE_TO_MANY, array('id' => 'account_id', ), 'CASCADE', 'CASCADE');
	} // buildRelations()
