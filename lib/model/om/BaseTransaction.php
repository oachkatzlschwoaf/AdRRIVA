...
abstract class BaseTransaction extends BaseObject  implements Persistent {
	...
	public function setPoints($v)
	{
		...
		if ($this->points !== $v) {
			$this->points = $v;
			$this->modifiedColumns[] = TransactionPeer::POINTS;
		}
	...
	public function setFee($v)
	{
		...
		if ($this->fee !== $v) {
			$this->fee = $v;
			$this->modifiedColumns[] = TransactionPeer::FEE;
		}
	...
	public function setFrom($v)
	{
		...
		if ($this->from !== $v) {
			$this->from = $v;
			$this->modifiedColumns[] = TransactionPeer::FROM;
		}
	...
	public function setTo($v)
	{
		...
		if ($this->to !== $v) {
			$this->to = $v;
			$this->modifiedColumns[] = TransactionPeer::TO;
		}
	...
	public function setFromUser($v)
	{
		...
		if ($this->from_user !== $v) {
			$this->from_user = $v;
			$this->modifiedColumns[] = TransactionPeer::FROM_USER;
		}
	...
	public function setToUser($v)
	{
		...
		if ($this->to_user !== $v) {
			$this->to_user = $v;
			$this->modifiedColumns[] = TransactionPeer::TO_USER;
		}
	...
	public function setInvoiceId($v)
	{
		...
		if ($this->invoice_id !== $v) {
			$this->invoice_id = $v;
			$this->modifiedColumns[] = TransactionPeer::INVOICE_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->fee = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->from = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->to = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->from_user = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->to_user = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->invoice_id = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->resetModified();
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getFrom(),
			$keys[6] => $this->getTo(),
			$keys[7] => $this->getFromUser(),
			$keys[8] => $this->getToUser(),
			$keys[9] => $this->getInvoiceId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setFee($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setFrom($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setTo($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setFromUser($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setToUser($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setInvoiceId($arr[$keys[9]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TransactionPeer::POINTS)) $criteria->add(TransactionPeer::POINTS, $this->points);
		if ($this->isColumnModified(TransactionPeer::AMOUNT)) $criteria->add(TransactionPeer::AMOUNT, $this->amount);
		if ($this->isColumnModified(TransactionPeer::FEE)) $criteria->add(TransactionPeer::FEE, $this->fee);
		if ($this->isColumnModified(TransactionPeer::FROM)) $criteria->add(TransactionPeer::FROM, $this->from);
		if ($this->isColumnModified(TransactionPeer::TO)) $criteria->add(TransactionPeer::TO, $this->to);
		if ($this->isColumnModified(TransactionPeer::FROM_USER)) $criteria->add(TransactionPeer::FROM_USER, $this->from_user);
		if ($this->isColumnModified(TransactionPeer::TO_USER)) $criteria->add(TransactionPeer::TO_USER, $this->to_user);
		if ($this->isColumnModified(TransactionPeer::INVOICE_ID)) $criteria->add(TransactionPeer::INVOICE_ID, $this->invoice_id);
