...
abstract class BaseAccountPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Balance', 'Status', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'balance', 'status', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::BALANCE, self::STATUS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'balance', 'status', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Balance' => 2, 'Status' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'balance' => 2, 'status' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::BALANCE => 2, self::STATUS => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'balance' => 2, 'status' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(OutgoingFundsPeer::ACCOUNT_ID, $obj->getId());
